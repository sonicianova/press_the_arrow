...
function gameOver(message) {
	running = false;
	replace("<img id='title' src='pta_title.png' /><br><br><div class='divider'></div><br><h2>"+message+"</h2><br><h3>Your final score was "+score+"</h3><br><button type='button' id='biggerButton' class='menuButton' onclick='begin()'>AGAIN!<p id='press_enter'>(Press Enter)</p></button>");
}
